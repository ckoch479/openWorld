...
void meshCollider::createCollider(std::vector <glm::vec3> vertices, std::vector <glm::vec3> vertexNormals)
{
	this->vertices = vertices;
	this->vertexNormals = vertexNormals;
}

glm::vec3 meshCollider::returnPosition()
{
	return this->position;
}

std::vector <glm::vec3> meshCollider::returnVertices()
{
...
void sphereCollider::createCollider(glm::vec3 position, float radius)
{
	this->position = position;
	this->radius = radius;
}

glm::vec3 sphereCollider::returnPosition()
{
	return this->position;
}
